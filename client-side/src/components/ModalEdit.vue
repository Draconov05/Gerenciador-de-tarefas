<template>
    <form class="h-[45vh] w-full border px-5 flex flex-col justify-center items-between overflow-y-auto py-5"
        ...
        <div class="flex flex-col h-full space-y-4 w-full justify-center">
            <div class="flex flex-col">
                ...
                <input required
                    class="border w-full cursor-default rounded-lg bg-white py-2 pl-3 pr-10 text-left shadow-md focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm"
                    name="titulo" type="text" v-model="localTask.titulo">
            </div>
            <div class="flex flex-col">
            ...
            <div class="flex flex-col">
                ...
                <div class="space-x-1 overflow-x-auto">
                    <BadgeDeletable v-for="(keyWord, index) in localTagsArr" :key="index" :value="keyWord" tipo="key"
                        @delete="removeFromTags"></BadgeDeletable>
                    <BadgeCreatable v-if="newTag" @save="saveNewTag" tipo="key" @delete="newTag = false">
                    </BadgeCreatable>
        ...
        <div class="mt-1 space-x-1">
            ...
            <button class="text-sm rounded-lg text-blue-400 bg-blue-100 px-2 py-1" type="button"
                @click="goToNoticias">Ver notícias</button>
        </div>
    </form>
</template>
